...
exports.allTour = asyncWrapper(async (req, res) => {
...
// book a tour
exports.BookTour = asyncWrapper(async (req, res) => {
...
// update booked tour
exports.updateBookedTour = asyncWrapper(async (req, res) => {
  const { tourId } = req.params;
...
exports.searchTour = asyncWrapper(async (req, res) => {
